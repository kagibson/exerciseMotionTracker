#
#  Be sure to run `pod spec lint ExerciseMotionTracker.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Kurtis Gibson"
  # s.authors            = { "Kurtis Gibson" => "kurtisgibsonmusic@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Kurtis Gibson"
